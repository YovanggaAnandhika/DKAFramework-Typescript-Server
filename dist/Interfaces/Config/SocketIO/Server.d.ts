...
/// <reference types="node" />
import { EngineSocketIO, SecurityAuthorizationCallbackBasic, SecurityAuthorizationCallbackOauth, SocketIOInstances, SocketIOInstancesMiddleware, SocketIOInstanceSocket, State } from "../../../Type/types";
